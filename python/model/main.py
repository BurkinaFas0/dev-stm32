...
import model.generate_data as gd



# Генерируем данные
X_train, y_train = gd.generate_data(2000)   # данные для обучения модели
X_test, y_test = gd.generate_data(400)      # Используется только для проверки
